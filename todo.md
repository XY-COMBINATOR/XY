...
- [ ] Replace the standalone Vercel tRPC wrapper with the lower-level native Node HTTP handler, validate all API entries, and deliver the follow-up through protected review.
